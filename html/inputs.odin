...
text_input :: proc(name: string, value: Maybe(string) = nil, placeholder: Maybe(string) = nil, class: []string = {}, data: []KeyValue = {}, autofocus: bool = false) -> string {
	return strings.concatenate([]string{"<input type=\"text\" name=\"", name, "\" ", attrs({{"value", value_from(value)}, {"placeholder", value_from(placeholder)}, {"class", strings.join(class, " ")}, {"autofocus", autofocus}}), attrs(data, "data-"), "/>"})
}
...
date_input :: proc(name: string, value: Maybe(time.Time) = nil, placeholder: Maybe(string) = nil, class: []string = {}, data: []KeyValue = {}, autofocus: bool = false) -> string {
	return strings.concatenate([]string{"<input type=\"date\" name=\"", name, "\" ", attrs({{"value", value_from(value)}, {"placeholder", value_from(placeholder)}, {"class", strings.join(class, " ")}, {"autofocus", autofocus}}), attrs(data, "data-"), "/>"})
}
...
date_time_input :: proc(name: string, value: Maybe(time.Time) = nil, placeholder: Maybe(string) = nil, class: []string = {}, data: []KeyValue = {}, autofocus: bool = false) -> string {
	return strings.concatenate([]string{"<input type=\"datetime-local\" name=\"", name, "\" ", attrs({{"value", value_from(value)}, {"placeholder", value_from(placeholder)}, {"class", strings.join(class, " ")}, {"autofocus", autofocus}}), attrs(data, "data-"), "/>"})
}
...
search_input :: proc(name: string, value: Maybe(string) = nil, placeholder: Maybe(string) = nil, class: []string = {}, data: []KeyValue = {}, autofocus: bool = false) -> string {
	return strings.concatenate([]string{"<input type=\"search\" name=\"", name, "\" ", attrs({{"value", value_from(value)}, {"placeholder", value_from(placeholder)}, {"class", strings.join(class, " ")}, {"autofocus", autofocus}}), attrs(data, "data-"), "/>"})
}
...
text_area :: proc(name: string, value: Maybe(string) = nil, placeholder: Maybe(string) = nil, rows: Maybe(int) = nil, class: []string = {}, data: []KeyValue = {}, autofocus: bool = false) -> string {
	return strings.concatenate([]string{"<textarea name=\"", name, "\" ", attrs({{"placeholder", value_from(placeholder)}, {"row", value_from(rows)}, {"class", strings.join(class, " ")}, {"autofocus", autofocus}}), attrs(data, "data-"), ">", value.? or_else "", "</textarea>"})
}
